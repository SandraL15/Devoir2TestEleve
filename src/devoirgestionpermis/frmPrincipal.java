...
//                    unNewEleve.AjouterUnTest(unNewTest);
                  ...
                  if(eleve.VerifierPresenceTest(test)){  
                      //il est present
                      //il faut vérifier s'il est termine
                      if(test.getTermine()){
                          //il est termine
                          //supprimer l'ancien
                          ...
                          //il ne l'est pas
                          JOptionPane.showMessageDialog(this, "Impossible de se reinscrire au meme test");
                          Test unNewTest = new Test(test.getIdTest(), test.getNomTest(), test.getNbFautes(), test.getTermine());
                          eleve.AjouterUnTest(unNewTest);
                      }
                  }
                  //on remet à jour la combobox des inscrits
...
//        }
        if(tblTests.getSelectedRow()==-1){
            JOptionPane.showMessageDialog(this, "selectionnez un test");
